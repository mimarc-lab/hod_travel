...
class SeedService {
  ...
  static List<Map<String, dynamic>> _costItemRows(
    ...
    return [
      ...
      {'team_id': teamId, 'created_by': userId, 'trip_id': t('t1'), 'supplier_id': sp('sp7'), 'item_name': 'Amalfi Limo — airport transfers (×3)',       'category': 'transport',     'city': 'Amalfi',    'service_date': '2025-09-14', 'currency': 'EUR', 'net_cost': 480,   'markup_type': 'percentage', 'markup_value': 20, 'sell_price': 576.0,    'payment_status': 'paid',    'approval_status': 'draft'},
      {'team_id': teamId, 'created_by': userId, 'trip_id': t('t1'), 'supplier_id': sp('sp8'), 'item_name': 'Amalfi Charters — private boat day',         'category': 'transport',     'city': 'Positano',  'service_date': '2025-09-15', 'currency': 'EUR', 'net_cost': 1200,  'markup_type': 'percentage', 'markup_value': 20, 'sell_price': 1440.0,   'payment_status': 'paid',    'approval_status': 'draft'},
      {'team_id': teamId, 'created_by': userId, 'trip_id': t('t1'), 'supplier_id': sp('sp6'), 'item_name': 'Villa Rufolo — concert access',              'category': 'experience',    'city': 'Ravello',   'service_date': '2025-09-16', 'currency': 'EUR', 'net_cost': 600,   'markup_type': 'percentage', 'markup_value': 25, 'sell_price': 750.0,    'payment_status': 'paid',    'approval_status': 'draft'},
      {'team_id': teamId, 'created_by': userId, 'trip_id': t('t1'), 'supplier_id': sp('sp12'),'item_name': 'Mamma Agata — private cooking class',        'category': 'experience',    'city': 'Ravello',   'service_date': '2025-09-17', 'currency': 'EUR', 'net_cost': 520,   'markup_type': 'percentage', 'markup_value': 25, 'sell_price': 650.0,    'payment_status': 'paid',    'approval_status': 'draft'},
      {'team_id': teamId, 'created_by': userId, 'trip_id': t('t1'), 'supplier_id': sp('sp3'), 'item_name': 'Rossellinis — dinner for 6',                 'category': 'dining',        'city': 'Ravello',   'service_date': '2025-09-15', 'currency': 'EUR', 'net_cost': 780,   'markup_type': 'fixed',      'markup_value': 0,  'sell_price': 780.0,    'payment_status': 'paid',    'approval_status': 'draft'},
      {'team_id': teamId, 'created_by': userId, 'trip_id': t('t1'), 'supplier_id': sp('sp15'),'item_name': 'La Caravella — seafood lunch',               'category': 'dining',        'city': 'Amalfi',    'service_date': '2025-09-17', 'currency': 'EUR', 'net_cost': 420,   'markup_type': 'fixed',      'markup_value': 0,  'sell_price': 420.0,    'payment_status': 'pending', 'approval_status': 'draft', 'payment_due_date': '2026-05-10'},
      {'team_id': teamId, 'created_by': userId, 'trip_id': t('t1'), 'supplier_id': sp('sp14'),'item_name': 'Marco Esposito — private guide (2 days)',    'category': 'guide',         'city': 'Amalfi',    'service_date': '2025-09-16', 'currency': 'EUR', 'net_cost': 700,   'markup_type': 'percentage', 'markup_value': 15, 'sell_price': 805.0,    'payment_status': 'due',     'approval_status': 'draft', 'payment_due_date': '2026-04-20', 'notes': '2 full days: Amalfi old town + Pompeii. Confirm vehicle included.'},
      {'team_id': teamId, 'created_by': userId, 'trip_id': t('t1'), 'item_name': 'Sicily internal transfers',                                             'category': 'logistics',     'city': 'Palermo',   'service_date': '2025-09-21', 'currency': 'EUR', 'net_cost': 380,   'markup_type': 'percentage', 'markup_value': 15, 'sell_price': 437.0,    'payment_status': 'pending', 'approval_status': 'draft'},
      ...
      {'team_id': teamId, 'created_by': userId, 'trip_id': t('t2'), 'item_name': 'Private tea ceremony — Kyoto',        'category': 'experience',    'city': 'Kyoto',              'service_date': '2026-09-11', 'currency': 'JPY', 'net_cost': 380,   'markup_type': 'percentage', 'markup_value': 25, 'sell_price': 475.0,    'payment_status': 'pending', 'approval_status': 'draft'},
