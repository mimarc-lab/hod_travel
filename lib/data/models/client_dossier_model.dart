...
enum TripType {
  ...
  static TripType? fromDb(String? v) => v == null
      ? null
...
enum PacingPreference {
  ...
  static PacingPreference? fromDb(String? v) => v == null
      ? null
      : PacingPreference.values.firstWhere(
          (e) => e.dbValue == v,
...
enum PrivacyPreference {
  ...
  static PrivacyPreference? fromDb(String? v) => v == null
      ? null
      : PrivacyPreference.values.firstWhere(
          (e) => e.dbValue == v,
          orElse: () => PrivacyPreference.standard,
        );
}
...
enum LuxuryLevel {
  ...
  static LuxuryLevel? fromDb(String? v) => v == null
      ? null
      : LuxuryLevel.values.firstWhere(
          (e) => e.dbValue == v,
          orElse: () => LuxuryLevel.high,
        );
}
...
enum GuidePreference {
  ...
  static GuidePreference? fromDb(String? v) => v == null
      ? null
      : GuidePreference.values.firstWhere(
          (e) => e.dbValue == v,
          orElse: () => GuidePreference.flexible,
        );
}
...
enum StructurePreference {
  ...
  static StructurePreference? fromDb(String? v) => v == null
      ? null
      : StructurePreference.values.firstWhere(
          (e) => e.dbValue == v,
          orElse: () => StructurePreference.balanced,
        );
}
...
enum AccommodationType {
  ...
  static AccommodationType? fromDb(String? v) => v == null
      ? null
...
enum DiningStyle {
  ...
  static DiningStyle? fromDb(String? v) => v == null
      ? null
      : DiningStyle.values.firstWhere(
          (e) => e.dbValue == v,
          orElse: () => DiningStyle.mixed,
        );
}
...
enum WellnessImportance {
  ...
  static WellnessImportance? fromDb(String? v) => v == null
      ? null
      : WellnessImportance.values.firstWhere(
          (e) => e.dbValue == v,
          orElse: () => WellnessImportance.preferred,
        );
}
...
enum HeatTolerance {
  ...
  static HeatTolerance? fromDb(String? v) => v == null
      ? null
      : HeatTolerance.values.firstWhere(
          (e) => e.dbValue == v,
          orElse: () => HeatTolerance.medium,
        );
}
...
enum WalkingTolerance {
  ...
  static WalkingTolerance? fromDb(String? v) => v == null
      ? null
      : WalkingTolerance.values.firstWhere(
          (e) => e.dbValue == v,
          orElse: () => WalkingTolerance.moderate,
        );
}
...
class ClientDossier {
  ...
  String get displayName => (familyName != null && familyName!.isNotEmpty)
      ? familyName!
      : primaryClientName;
  ...
  factory ClientDossier.fromMap(
    ...
    return ClientDossier(
      ...
      pacingPreference: PacingPreference.fromDb(
        r['pacing_preference'] as String?,
      ),
      privacyPreference: PrivacyPreference.fromDb(
        r['privacy_preference'] as String?,
      ),
      ...
      structurePreference: StructurePreference.fromDb(
        r['structure_preference'] as String?,
      ),
      accommodationType: AccommodationType.fromDb(
        r['accommodation_type'] as String?,
      ),
      beddingPreferences: r['bedding_preferences'] as String?,
      wellnessImportance: WellnessImportance.fromDb(
        r['wellness_importance'] as String?,
      ),
      ...
      walkingTolerance: WalkingTolerance.fromDb(
        r['walking_tolerance'] as String?,
      ),
  ...
  ClientDossier copyWith({
    ...
    typicalTripType: clearTripType
        ? null
        : (typicalTripType ?? this.typicalTripType),
    groupDynamicNotes: clearGroupDynamicNotes
        ? null
        : (groupDynamicNotes ?? this.groupDynamicNotes),
    pacingPreference: clearPacing
        ? null
        : (pacingPreference ?? this.pacingPreference),
    privacyPreference: clearPrivacy
        ? null
        : (privacyPreference ?? this.privacyPreference),
    luxuryLevel: clearLuxury ? null : (luxuryLevel ?? this.luxuryLevel),
    guidePreference: clearGuide
        ? null
        : (guidePreference ?? this.guidePreference),
    structurePreference: clearStructure
        ? null
        : (structurePreference ?? this.structurePreference),
    accommodationType: clearAccommodation
        ? null
        : (accommodationType ?? this.accommodationType),
    beddingPreferences: clearBedding
        ? null
        : (beddingPreferences ?? this.beddingPreferences),
    wellnessImportance: clearWellness
        ? null
        : (wellnessImportance ?? this.wellnessImportance),
    ...
    alcoholPreference: clearAlcohol
        ? null
        : (alcoholPreference ?? this.alcoholPreference),
    ...
    walkingTolerance: clearWalking
        ? null
        : (walkingTolerance ?? this.walkingTolerance),
    accessibilityNotes: clearAccessibility
        ? null
        : (accessibilityNotes ?? this.accessibilityNotes),
    securitySensitivity: clearSecurity
        ? null
        : (securitySensitivity ?? this.securitySensitivity),
    photographySensitivity: clearPhotography
        ? null
        : (photographySensitivity ?? this.photographySensitivity),
    internalNotes: clearInternalNotes
        ? null
        : (internalNotes ?? this.internalNotes),
    pastFeedbackNotes: clearPastFeedback
        ? null
        : (pastFeedbackNotes ?? this.pastFeedbackNotes),
    serviceStyleNotes: clearServiceStyle
        ? null
        : (serviceStyleNotes ?? this.serviceStyleNotes),
