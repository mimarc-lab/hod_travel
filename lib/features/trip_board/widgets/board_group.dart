...
/// Collapsible board group — fills available width (no fixed pixel constraint).
              ...
              children: [
                ...
                Text(
                  ...
                  style: AppTextStyles.heading3
                      .copyWith(color: group.accentColor),
                ),
                const SizedBox(width: AppSpacing.sm),
                ...
                // Add task button — stops tap from bubbling to collapse handler.
                if (_expanded)
                  GestureDetector(
            ...
            children: group.tasks
                .map(
                  (task) => Column(
                    ...
                    children: [
                      const Divider(
                          height: 1, color: Color(0xFFECEAE7)),
                      TaskRow(
