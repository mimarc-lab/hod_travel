...
import '../../../features/security/dossier_access_guard.dart';
...
class ClientDossierListScreen extends StatefulWidget {
  ...
  @override
  State<ClientDossierListScreen> createState() =>
      _ClientDossierListScreenState();
}
...
class _ClientDossierListScreenState extends State<ClientDossierListScreen> {
  ...
  void _openDetail(ClientDossier dossier) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) =>
            ClientDossierDetailScreen(dossier: dossier, provider: _provider),
      ),
    );
  }
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: ListenableBuilder(
          listenable: provider,
          builder: (_, _) => provider.searchQuery.isNotEmpty
              ? GestureDetector(
                  onTap: () {
                    ctrl.clear();
                    provider.setSearch('');
